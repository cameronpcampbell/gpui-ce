...
mod tests {
    ...
    fn inset_transitions_interpolate_auto_as_unit_appropriate_zero() {
        ...
        let targets = Edges {
            ...
            bottom: Length::Definite(DefiniteLength::Fraction(0.4)),
            left: length(-20.0),
        };
        let zeros = Edges {
            top: length(0.0),
            right: Length::Definite(DefiniteLength::Absolute(AbsoluteLength::Rems(rems(0.0)))),
            bottom: Length::Definite(DefiniteLength::Fraction(0.0)),
            left: length(0.0),
        };
        let midpoints = Edges {
            top: length(10.0),
            right: Length::Definite(DefiniteLength::Absolute(AbsoluteLength::Rems(rems(1.0)))),
            bottom: Length::Definite(DefiniteLength::Fraction(0.2)),
            left: length(-10.0),
        };
        ...
        let new_targets = Edges {
            top: Length::Definite(DefiniteLength::Fraction(0.6)),
            right: length(30.0),
            bottom: Length::Definite(DefiniteLength::Absolute(AbsoluteLength::Rems(rems(3.0)))),
            left: Length::Definite(DefiniteLength::Fraction(-0.2)),
        };
        let new_zeros = Edges {
            top: Length::Definite(DefiniteLength::Fraction(0.0)),
            right: length(0.0),
            bottom: Length::Definite(DefiniteLength::Absolute(AbsoluteLength::Rems(rems(0.0)))),
            left: Length::Definite(DefiniteLength::Fraction(0.0)),
        };
